...
if ( !function_exists('berea_scripts') ) :
	...
	function berea_scripts() {
		...
		if ( TRUE || SCRIPT_DEBUG || WP_DEBUG ) :
			...
			wp_enqueue_script( 'production.js?6b193747fc', get_template_directory_uri() . '/assets/js/production.js?6b193747fc', array( 'jquery' ), '1.0.0', false );
			...
			wp_enqueue_script( 'production.js?6b193747fc', get_template_directory_uri() . '/assets/js/production-min.js?533fa321c3', array( 'jquery' ), '1.0.0', false );
