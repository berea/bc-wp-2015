...
if ( !function_exists('berea_scripts') ) :
	...
	function berea_scripts() {
		...
		if ( TRUE || SCRIPT_DEBUG || WP_DEBUG ) :
			...
			wp_enqueue_script( 'production.js?c919529ecb', get_template_directory_uri() . '/assets/js/production.js?c919529ecb', array( 'jquery' ), '1.0.0', false );
			...
			wp_enqueue_script( 'production.js?c919529ecb', get_template_directory_uri() . '/assets/js/production-min.js?533fa321c3', array( 'jquery' ), '1.0.0', false );
