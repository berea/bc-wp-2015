...
if ( !function_exists('berea_scripts') ) :
	...
	function berea_scripts() {
		...
		if ( TRUE || SCRIPT_DEBUG || WP_DEBUG ) :
			...
			wp_enqueue_script( 'production.js?110ab0676d', get_template_directory_uri() . '/assets/js/production.js?110ab0676d', array( 'jquery' ), '1.0.0', false );
			...
			if (wp_get_theme()->name != 'Berea 2015 - Stopgap Child Theme') {
				wp_enqueue_style( 'berea-style',  get_template_directory_uri() . '/assets/css/style-v1.css?93ca426a29' );
			}
			else {
			...
			wp_enqueue_script( 'production.js?110ab0676d', get_template_directory_uri() . '/assets/js/production-min.js?533fa321c3', array( 'jquery' ), '1.0.0', false );
