...
if ( !function_exists('berea_scripts') ) :
	...
	function berea_scripts() {
		...
		if ( TRUE || SCRIPT_DEBUG || WP_DEBUG ) :
			...
			wp_enqueue_script( 'production.js?fb3444c9af', get_template_directory_uri() . '/assets/js/production.js?fb3444c9af', array( 'jquery' ), '1.0.0', false );
			...
			wp_enqueue_script( 'production.js?fb3444c9af', get_template_directory_uri() . '/assets/js/production-min.js?533fa321c3', array( 'jquery' ), '1.0.0', false );
