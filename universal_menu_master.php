			...
			<ul class="cd-nav-icons is-hidden">
				...
				<li>
					...
					<a class="cd-nav-item" href="https://www.berea.edu/academics/">
						<img class="academic-icon" src="https://bereaedu.staging.wpengine.com/wp-content/themes/bc-wp-2015/assets/images/icons/academic-programs.svg" alt="Academic Programs Icon"/>
				...
				<li>
					<a class="cd-nav-item" href="https://www.berea.edu/labor-program/">
						<img class="academic-icon" src="https://bereaedu.staging.wpengine.com/wp-content/themes/bc-wp-2015/assets/images/icons/labor-programs.svg" alt="Labor Programs Icon"/>
						<h3>LABOR PROGRAM</h3>
				...
				<li>
					<a class="cd-nav-item" href="http://libraryguides.berea.edu/">
						<img class="academic-icon" src="https://bereaedu.staging.wpengine.com/wp-content/themes/bc-wp-2015/assets/images/icons/library.svg" alt="Library Icon"/>
						<h3>LIBRARY</h3>
				...
				<li>
					<a class="cd-nav-item" href="https://www.berea.edu/registrar/">
						<img class="academic-icon" src="https://bereaedu.staging.wpengine.com/wp-content/themes/bc-wp-2015/assets/images/icons/registrar.svg" alt="Registrar's Office Icon"/>
				...
				<li>
					<a class="cd-nav-item" href="http://community.berea.edu/calendar/main.php?calendarid=default&view=upcoming">
						<img class="academic-icon" src="https://bereaedu.staging.wpengine.com/wp-content/themes/bc-wp-2015/assets/images/icons/calendar.svg" alt="Academic Calendar Icon"/>
				...
				<li>
					<a class="cd-nav-item" href="https://www.berea.edu/academics/">
						<img class="academic-icon" src="https://bereaedu.staging.wpengine.com/wp-content/themes/bc-wp-2015/assets/images/icons/centers.svg" alt="Centers Icon"/>
						<h3>CENTERS</h3>
				...
				<li>
					<a class="cd-nav-item" href="http://catalog.berea.edu/en/Current/Catalog">
						<img class="academic-icon" src="https://bereaedu.staging.wpengine.com/wp-content/themes/bc-wp-2015/assets/images/icons/student-handbook.svg" alt="Student Handbook Icon"/>
				...
				<li>
					<a class="cd-nav-item" href="https://www.berea.edu/campus/">
						<img class="academic-icon" src="https://bereaedu.staging.wpengine.com/wp-content/themes/bc-wp-2015/assets/images/icons/resources.svg" alt="Resources Icon"/>
						<h3>RESOURCES</h3>
				...
				<li>
					<a class="cd-nav-item" href="/avp/faculty-scholarly-creative-works-2014-2015-2/">
