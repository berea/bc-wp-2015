	...
	<ul class="cd-secondary-nav is-hidden">
				...
				<ul class="is-hidden">
					...
					<li class="has-children">
						...
						<ul class="is-hidden">
							...
							<li><a href="#">Center for Excellence in Learning Through Service</a></li>
		...
		<li class="has-children">
			...
			<ul class="is-hidden">
				...
				<li><a href="#">Visit Berea College/Visitor Center&amp; Shoppe</a></li>
		...
		<li class="has-children">
			...
			<ul class="cd-secondary-nav is-hidden">
				<li class="go-back"><a href="#0">BACK</a></li>
				<li class="see-all"><a href="/admissions/">ADMISSIONS</a></li>
				<li class="has-children">
					<a href="/admissions/">ADMISSION INFO</a>

					<ul class="is-hidden">
						<li class="go-back"><a href="#0">BACK</a></li>
						<li><a href="/admissions/visit-berea-college/bereas-academic-requirements/">Admission Requirements</a></li>
						<li><a href="/admissions/applying-for-admission/">Application Forms</a></li>
						<li><a href="/admissions/applying-freshman/">New Freshmen</a></li>
						<li><a href="/admissions/international/">International Students</a></li>
						<li><a href="/admissions/transfer-application/">Transfer Students</a></li>
					</ul>
				</li>
				<li class="has-children">
					...
					<ul class="is-hidden">
						<li class="go-back"><a href="#0">BACK</a></li>
						<li><a href="/admissions/why-berea/career-preparation/">Career Preparation</a></li>
						<li><a href="http://www.bereaathletics.com/">Athletics</a></li>
						<li><a href="/cie/education-abroad-and-exchanges-menu/">Education Abroad</a></li>
						<li><a href="/admissions/why-berea/service-and-leadership/">Service and Leadership</a></li>
					</ul>
				</li>
				<li class="has-children">
					<a href="/student-financial-aid/">FINANCIAL AID</a>

					<ul class="is-hidden">
						<li class="go-back"><a href="#0">BACK</a></li>
						<li><a href="/admissions/financial-aid-scholarships/bereas-tuition-scholarship/">Tuition Promise Scholarship</a></li>
						<li><a href="/student-financial-aid/types-of-financial-aid/">Labor Grant Aid</a></li>
						<li><a href="/admissions/quick-estimator/">Financial Eligibility</a></li>
						<li><a href="https://berea.studentaidcalculator.com">Estimate First-Year Costs</a></li>
						<li><a href="/admissions/applying-for-admission/">Submit and RFQ</a></li>
					</ul>
				</li>
				<li class="has-children menu-item-show-on-large">
					<div class="cd-item-as-button button-green"><a id="admissions-apply-button" href="/admissions/applying-for-admission/">APPLY TODAY</a></div>
					<div class="cd-item-as-button button-blue"><a id="admissions-eligible-button" href="/admissions/quick-estimator/">CONFIRM YOUR FINANCIAL ELIGIBILITY</a></div>
					<div class="cd-item-as-button button-purple"><a id="admissions-visit-button" href="/admissions/visit-campus/">SCHEDULE A CAMPUS VISIT</a></div>
				</li>
				<li class="cd-item-as-button menu-item-hide-on-large button-green"><a id="admissions-apply-button" href="/admissions/applying-for-admission/">APPLY TODAY</a></li>
				<li class="cd-item-as-button menu-item-hide-on-large button-blue"><a id="admissions-eligible-button"href="/admissions/quick-estimator/">CONFIRM YOUR FINANCIAL ELIGIBILITY</a></li>
				<li class="cd-item-as-button menu-item-hide-on-large button-purple"><a id="admissions-visit-button" href="/admissions/visit-campus/">SCHEDULE A CAMPUS VISIT</a></li>
			</ul>
		</li>
		...
		<li class="has-children">
			...
			<ul class="cd-nav-icons is-hidden">
				...
				<li>
					<a class="cd-nav-item item-1" href="/academics/">
				...
				<li>
					<a class="cd-nav-item item-2" href="/labor-program/">
						<h3>LABOR PROGRAM</h3>
				...
				<li>
					<a class="cd-nav-item item-4" href="/academics/">
						<h3>MAJORS &amp; MINORS</h3>
						<p>Bachelor of Arts and Bachelor of Science degrees in 28 fields</p>
					</a>
				</li>
				...
				<li>
					<a class="cd-nav-item item-6" href="/academics/">
						<h3>CENTERS</h3>
				...
				<li>
					<a class="cd-nav-item item-8" href="/campus/">
						<h3>RESOURCES</h3>
				...
				<li>
					<a class="cd-nav-item item-8" href="/avp/faculty-scholarly-works-2013-2014/">
		...
		<li>
			<a href="/give-to-berea/the-berea-fund/">GIVE</a>
		</li>
