	...
	<div class="footer-floats">
		...
		<div class="footer-distinctly">
			<h3>DISTINCTLY BEREAN</h3>
				...
				<a href="https://www.berea.edu/visitor-center"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/visitorcenter165x59.png" alt="Visitor Center &amp; Shoppes"/></a>
				<br><br><br>
...
<div class="footer-social">
		<p>
			...
			<!-- <a href="#"><span class="group-elements"><img class="vertical-center" src="<?php echo get_template_directory_uri(); ?>/assets/images/icons/rss.png" alt="RSS" width="25" height="25" /><span class="vertical-center nudge-half-right">RSS</span></span></a> -->
		</p>
</div><!-- .footer-social -->
