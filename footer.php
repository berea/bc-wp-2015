...
<div class="footer-main">
	...
	<div class="footer-floats">
		...
		<div class="footer-promise">
			...
			<p>Our generous <strong class="text-uppercase">Tuition promise sholarship</strong> makes it possible for you to graduate debt-free. Even if you borrow for special learning opportunities or to replace your family’s total contribution, you will have a low debt compared to national trends. We sometimes call Berea “the best education money can’t buy.”</p>
		</div><!-- .footer-promise -->
		...
		<div class="footer-distinctly">
			<h3 class="element-uppercase">Distinctly Berean</h3>
				...
				<br><br><br>
				<a href="http://www.bereacrafts.com/"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/studentcrafts165x42.png" aria-label="Student Crafts"/></a>
				<br><br><br>
